...
public class R15StatementPage extends GuidePage implements View.OnClickListener {
    public R15StatementPage(Context context, int flag) {
        super(context);
        mFlag = flag;
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View v = mInflater.inflate(R.layout.activity_r15_statement_page, null);
        addView(v);
        initView();
    }
