...
public class FingerprintPage2 extends GuidePage implements View.OnClickListener {
    public FingerprintPage2(Context context) {
        super(context);
        init(context);
    }
    ...
    public FingerprintPage2(Context context, AttributeSet attr) {
        super(context, attr);
        init(context);
    }
