...
public class CompletePage2 extends GuidePage implements View.OnClickListener {
    public CompletePage2(Context context) {
        super(context);
        init(context);
    }

    public CompletePage2(Context context, AttributeSet attr) {
        super(context, attr);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        backTxt.setVisibility(GONE);
        back.setBackgroundResource(R.drawable.actionbar_back_button2);
    }
