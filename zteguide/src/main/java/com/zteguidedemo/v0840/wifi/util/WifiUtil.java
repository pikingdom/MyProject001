	...
	public enum WIFI_RSSI {
		...
		RSSI_PERFECT {
			...
			public int getIconRes(Context ctx) {
				return R.drawable.zx_wifi_rssi_level_perfect;
			}
		},
		...
		RSSI_GOOD {
			...
			public int getIconRes(Context ctx) {
				return R.drawable.zx_wifi_rssi_level_good;
			}
		},
		...
		RSSI_NORMAL {
			...
			public int getIconRes(Context ctx) {
				return R.drawable.zx_wifi_rssi_level_normal;
			}
		},
		...
		RSSI_BAD {
			...
			public int getIconRes(Context ctx) {
				return R.drawable.zx_wifi_rssi_level_bad;
			}
		},
		...
		RSSI_NOTHING {
			...
			public int getIconRes(Context ctx) {
				return R.drawable.zx_wifi_rssi_level_nothing;
			}
		};
