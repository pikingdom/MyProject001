 ...
 */
public class ZTE0840Dialog extends Dialog {

    private Context mContext;
    public ZTE0840Dialog(Context context) {
        this(context, R.style.Dialog_Fullscreen);
    }

    public ZTE0840Dialog(Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_zte_0840_dialog);
