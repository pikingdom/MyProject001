 ...
 * vivo  y79 引导主界面
 */
public class VivoY79GuideMainView extends LinearLayout implements IGuideView,ChangeViewInterface {
    private Context context;
    private IGuideCallback iGuideCallback;
    private  View contentView = null;
    private boolean isSkipVivoServiceDesc = false;;//是否跳过显示服务说明页面
    public VivoY79GuideMainView(Context context, IGuideCallback iGuideCallback) {
        super(context);
    ...
    public void setCurrentlyShowView(int type){
        ...
        switch (type){
            case LANGUAGE_VIEW://语言视图
                contentView = new VivoLanguageChooseView_Y79(context,this);
                break;
