...
public class LanguageAdapter_y79 extends BaseAdapter {
    private Context mContext;
    private LayoutInflater mInflater;
    private String[] mLanguageArr;

    public LanguageAdapter_y79(Context context, String[] data) {
    ...
    public View getView(final int position, View converView, ViewGroup viewGroup) {
        ...
        if (converView == null) {
            converView = mInflater.inflate(R.layout.language_view_item_y79, null);
