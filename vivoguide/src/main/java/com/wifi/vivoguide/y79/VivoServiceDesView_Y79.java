 ...
 */
public class VivoServiceDesView_Y79 extends RelativeLayout implements View.OnClickListener {
    ...
    public VivoServiceDesView_Y79(Context context) {
        super(context);
    }

    public VivoServiceDesView_Y79(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VivoServiceDesView_Y79(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public VivoServiceDesView_Y79(Context context, boolean isSkipVivoServiceDesc1, ChangeViewInterface changeViewInterface1, onVivoClickListener onVivoClickListener1) {
        super(context);
    ...
    private void initView() {
        View.inflate(getContext(), R.layout.vivo_service_dec_view_y79,this);
