...
import com.wifi.vivoguide.wifi.Dialog.WifiConnectedDialogView;
...
public class WifiHelper {
	...
	public static String changeName(Context ctx, KeyMgmt type) {
		...
		case SECURITY_WPA2_EAP:
			name = ctx.getString(R.string.wifi_keymgmt_802);
			break;
		case SECURITY_WPA2_PSK_USE_WPS:
			name = ctx.getString(R.string.wifi_keymgmt_wpa2_use_wps);
			break;
		default:
			break;
		}
	...
	public static void showAlertDialog(Context ctx, String title, String message
		...
		WifiConnectedDialogView.Builder builder = new WifiConnectedDialogView.Builder(ctx);
