...
import com.wifi.vivoguide.Business.WifiHelper.KeyMgmt;
...
public class WifiConnect {
	...
	private WifiConfiguration CreateWifiInfo(WifiBean wifiBean) {
		...
		PskType type = WifiHelper.getSecurityType(wifiBean.getCapabilities());
