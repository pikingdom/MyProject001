 ...
 */
public class VivoFingelAction1_y85a extends RelativeLayout {
    ...
    public VivoFingelAction1_y85a(Context context) {
        super(context);
        init();
    }

    public VivoFingelAction1_y85a(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public VivoFingelAction1_y85a(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public VivoFingelAction1_y85a(Context activity, ChangeViewInterface changeViewInterface1) {
        super(activity);
    ...
    private void init(){
        View.inflate(getContext(), R.layout.vivo_fingle_action1_y85a,this);
        ...
        jumpText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if(changeViewInterface != null){
                    changeViewInterface.setCurrentlyShowView(ChangeViewInterface.FINGLE_ACTION_2);
                }
            }
        });
    }
