 ...
 * 
 */
public class VivoChooseServiceView_y79a extends RelativeLayout implements OnClickListener{
	...
	public VivoChooseServiceView_y79a(Context activity,ChangeViewInterface changeViewInterface1) {
		super(activity);
		this.mActivity = activity;
		this.changeViewInterface = changeViewInterface1;
		LayoutInflater.from(activity).inflate(R.layout.choose_service_view_y79a, this);
	...
	public void onClick(View v) {
		...
		if (id == R.id.cancel) {
			...
			if(changeViewInterface != null){
				changeViewInterface.setCurrentlyShowView(ChangeViewInterface.LOGIN_VIVO_ACCOUNT);
			}
