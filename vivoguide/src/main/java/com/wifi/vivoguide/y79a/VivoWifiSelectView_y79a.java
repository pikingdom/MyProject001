 ...
 */
public class VivoWifiSelectView_y79a extends RelativeLayout implements SystemEvent.EventListener {
    ...
    public VivoWifiSelectView_y79a(Context context) {
        super(context);
    }

    public VivoWifiSelectView_y79a(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VivoWifiSelectView_y79a(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public VivoWifiSelectView_y79a(Context activity, ChangeViewInterface changeViewInterface1) {
        super(activity);
        mActivity = activity;
        mGuideCallbackListener = changeViewInterface1;
        //mActivity.requestWindowFeature(Window.FEATURE_NO_TITLE);
        mWifiManager = (WifiManager)mActivity.getSystemService(Context.WIFI_SERVICE);
        mWifiSetView = LayoutInflater.from(activity).inflate(R.layout.vivo_wifi_list_main_y79a, this);
    ...
    private void jumpToNextView() {
        if(mGuideCallbackListener != null){//LOGIN_VIVO_ACCOUNT
            mGuideCallbackListener.setCurrentlyShowView(ChangeViewInterface.LOGIN_VIVO_ACCOUNT);
        }
