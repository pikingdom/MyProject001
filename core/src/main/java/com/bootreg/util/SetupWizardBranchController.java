 ...
 */
public class SetupWizardBranchController {
     ...
     * 超前（illusion）- com.android.launcher8
     ...
     魔品 - com.android.newline.magiclauncher
     7.7 ~ 7.7.x
     ...
     * @time 2018/1/3 15:06
     */
    public static boolean isTianpanChild1(Context context) {
        try {
            String versName = TelephoneUtil.getVersionName(context);
            if (!TextUtils.isEmpty(versName) && versName.startsWith("8.0.7")) {
                return true;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    /**
     * Description:是否新时空定制版/捷兴定制版复用该版本区间
     * Author: guojianyun
     * Date: 2016年8月17日 上午10:44:24
     *
     * @return
     */
    public static boolean isJieXing(Context context) {
        try {
            String versName = TelephoneUtil.getVersionName(context);
    ...
    public static boolean is2345Child1(Context context) {
        try {
            String versName = TelephoneUtil.getVersionName(context);
            if (!TextUtils.isEmpty(versName) && versName.startsWith("7.8.5")) {
                return true;
            }
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @time 2017/9/21 11:44
     */
    public static boolean isMopin(Context context) {
        try {
            String versName = TelephoneUtil.getVersionName(context);
