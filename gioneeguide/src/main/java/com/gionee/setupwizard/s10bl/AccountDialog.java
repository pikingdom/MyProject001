...
public class AccountDialog extends Dialog {
    ...
    public AccountDialog(Context context, int themeResId) {
        super(context, themeResId);
        this.mContext =context;
        init();
    }

    public AccountDialog(Context context, String title1, String desc1, String cancle1, String submit1) {
        this(context, R.style.Dialog_Fullscreen);
        this.title = title1;
        this.desc = desc1;
        this.cancle = cancle1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gn_view_account_dialog);
