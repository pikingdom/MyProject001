package com.gionee.setupwizard.utils;
...
public class WifiUtils {
	...
	public int IsConfiguration(String SSID){
		...
		for(int i = 0; i < wifiConfigList.size(); i++){
			...
			if(wifiConfigList.get(i).SSID.equals(SSID) || wifiConfigList.get(i).SSID.equals("\""+SSID+"\"")){//地址相同
	...
	public int getWifiLevel(int level){
		return localWifiManager.calculateSignalLevel(level,4);
	}
}
