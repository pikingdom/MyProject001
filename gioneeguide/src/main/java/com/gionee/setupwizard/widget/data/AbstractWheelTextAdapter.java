 ...
 */
package com.gionee.setupwizard.widget.data;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	/** Default text color */
	public static final int DEFAULT_TEXT_COLOR = 0xFF00ffff;

	/** Default text color */
	public static final int LABEL_COLOR = 0xFF00ffff;
