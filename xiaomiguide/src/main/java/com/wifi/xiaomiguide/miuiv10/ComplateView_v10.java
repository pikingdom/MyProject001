 ...
 */
public class ComplateView_v10 extends RelativeLayout{
    private ChangeViewInterface mChangeViewInterface;

    public ComplateView_v10(Context context, ChangeViewInterface changeViewInterface) {
        super(context,null);
        mChangeViewInterface = changeViewInterface;
        initView();
    }

    public ComplateView_v10(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ComplateView_v10(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

    }

    private void initView() {
        View.inflate(getContext(), R.layout.miui_view_complate_v10,this);
