package com.wifi.xiaomiguide.Adapter;
...
public class WifiSettingAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View converView, ViewGroup viewGroup) {
        ...
        if (converView == null) {
            converView = mInflater.inflate(R.layout.miui_wifi_settint_item_view, null);
            holder = new ViewHolder();
            holder.wifiItem = (View) converView.findViewById(R.id.miui_wifi_item);
            holder.wifiFlagIcon = (ImageView) converView.findViewById(R.id.miui_wifi_flag_icon);
            holder.wifiKeyLock = (ImageView) converView.findViewById(R.id.miui_wifi_key_lock);
            holder.wifiSsid = (TextView) converView.findViewById(R.id.miui_wifi_ssid);
            holder.wifiSet = (ImageView) converView.findViewById(R.id.miui_wifi_set);
            holder.selImage = (ImageView) converView.findViewById(R.id.miui_sel_image);
