...
public class MIUI_V9GuideMainView extends LinearLayout implements IGuideView,ChangeViewInterface {
    ...
    public MIUI_V9GuideMainView(Context context, IGuideCallback iGuideCallback) {
        super(context);
    ...
    public void setCurrentlyShowView(int viewType, Object obj) {
        switch (viewType){
            case MIUI_VIEW:
                mIsFirstStartView = true;
                contentView = new MiuiView_v9(context,this);
                break;
            ...
            case PERSONNAL_STYLE:
                ...
                break;
            case FINISH_VIEW:
                contentView = new ComplateView_v9(context, this);
                break;
